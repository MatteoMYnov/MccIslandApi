...
func Emptyinfos() *MccInfos {
	Infos := MccInfos{
		...
		CrownObtained:     0,
		CrownObtainable:   0,
		FishingData:       FishingData{Level: 0, NextLevelProgress: NextLevelProgress{CrownObtained: 0, CrownObtainable: 0}},
		Currency:          Currency{Coins: 0, RoyalReputation: 0, Silver: 0, MaterialDust: 0, AnglrTokens: 0},
		Trophies:          Trophies{Obtained: 0, Obtainable: 0, Bonus: 0},
		TrophiesSKILL:     Trophies{Obtained: 0, Obtainable: 0},
		TrophiesSTYLE:     Trophies{Obtained: 0, Obtainable: 0},
		TrophiesANGLER:    Trophies{Obtained: 0, Obtainable: 0},
		Friends:           []Friend{},
		EquippedCosmetics: []EquippedCosmetic{},
		Hats:              []InvCos{},
		Accessories:       []InvCos{},
